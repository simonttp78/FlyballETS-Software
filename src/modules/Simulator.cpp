...
void SimulatorClass::Main()
{
   ...
   if (bExecuteSimRaceChange)
   {
      ...
      {
         _iDataStartPos = TRIGGER_QUEUE_LENGTH * iSimulatedRaceID;
         _iDataPos = _iDataStartPos;
         PROGMEM_readAnything(&SimulatorQueue[_iDataPos], PendingRecord);
         _bNoMoreValidTriggers = false;
...
/// </summary>
const SimulatorClass::SimulatorRecord SimulatorClass::SimulatorQueue[TRIGGER_QUEUE_LENGTH * NumSimulatedRaces] PROGMEM = {
   ...
   {0, 0, 0},
   {0, 0, 0},
   // Testcase 51 --> temp: race 1, dog 1 commingback outside the gate
   {1, 30249, 1},
   {2, 77339, 1},
   {1, 121961, 0},
   {2, 172825, 0},
   ...
   {0, 0, 0},
   {0, 0, 0},
   // Testcase 52 --> race 142-14 false detection of false 'ok' for dog3
